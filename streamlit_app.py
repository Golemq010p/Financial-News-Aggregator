            ...
            with cols[idx]:
                ...
                with st.container(height=400, border=False):
                    ...
                    for _, row in group.iterrows():
                        ...
                        st.markdown(f"""
                            <div style="{container_style} padding: 10px; border-radius: 5px; margin-bottom: 12px; position: relative;">
                                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                    <div style="font-size: 0.9rem; color: #ffd700; font-weight: bold;">{display_time_est} EST {next_badge}</div>
                                </div>
                                <div style="font-size: 0.95rem; font-weight: bold; margin-top: 4px; color: #ffffff;">{row['country'] or ''} {row['title']}</div>
                                <div style="font-size: 0.85rem; margin-top: 6px; color: {'#dddddd' if is_past else '#ffffff'};">
